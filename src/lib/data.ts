import type { User, Lead, Assignment, Disposition, SubDisposition } from './types';

export const users: User[] = [
  { id: 'usr_1', name: 'Admin User', phone: '1112223331', role: 'admin', active: true, createdAt: '2023-01-15T09:30:00Z', avatar: '/avatars/01.png' },
  { id: 'usr_2', name: 'Jane Doe', phone: '1112223332', role: 'caller', active: true, createdAt: '2023-01-16T10:00:00Z', avatar: '/avatars/02.png' },
  { id: 'usr_3', name: 'John Smith', phone: '1112223333', role: 'caller', active: true, createdAt: '2023-01-17T11:45:00Z', avatar: '/avatars/03.png' },
  { id: 'usr_4', name: 'Emily White', phone: '1112223334', role: 'caller', active: false, createdAt: '2023-01-18T14:00:00Z', avatar: '/avatars/04.png' },
];
